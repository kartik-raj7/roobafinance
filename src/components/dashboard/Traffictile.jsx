...
const data={
  ...
  return (
    <div style={{width:'48%',backgroundColor:'#f6f6fb',borderRadius:'12px',display:'flex',flexDirection:'column',alignItems:'center'}}>
        <h4 style={{borderBottom:'2px solid grey',paddingBottom:'15px',padding:'12px',width:'80%'}}>Traffic Sources</h4>
        ...
        <div style={{display:'flex',flexDirection:'column',width:'100%'}}>
            ...
            <div style={{display:'flex',flexDirection:'row',justifyContent:'space-around',width:'90%',padding:'12px',borderRadius:'18px'}}>
